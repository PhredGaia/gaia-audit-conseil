...
const items = [
	...
	},
	{
		...
		icon: (
			<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
				<circle cx="12" cy="8" r="5"/><path d="M8.5 13.5L7 22l5-3 5 3-1.5-8.5"/>
			</svg>
		),
	},
	{
				...
				<div className="approach__grid">
					<div className="approach__image-col">
						...
						<div className="approach__quote-card">
							<p>{"L'objectif est de structurer des démarches claires, efficaces et compréhensibles, sans sur-documentation ni complexité inutile."}</p>
						</div>
					</div>
					<div className="approach__content">
						<span className="approach__label">Notre Approche</span>
						<h2 className="approach__title">Du référentiel au terrain. Du terrain au système.</h2>
						...
						<ul className="approach-list">
							{items.map((item) => (
								<li key={item.title}>
									<span className="approach-list__icon">{item.icon}</span>
